    ...
    func getWeather(completed: @escaping() -> ()){
        ...
        Alamofire.request(weatherURL).responseJSON{ response in
            ...
            case .success(let value):
                ...
                if let summary = json["daily"]["summary"].string { self.currentSummary = summary
                } else {
                ...
                for hour in 1...hours{
                    ...
                    let newHourlyForecast = HourlyForecast(hourlyTime: hourlyTime, hourlyTemeprature: hourlyTemperature, hourlyIcon: hourlyIcon, hourlyPrecipProb: hourlyPrecipProb)
